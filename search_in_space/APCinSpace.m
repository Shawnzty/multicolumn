...
% get the change of APC in parameter space
Delta_e_start = 0; % cannot equal to 0
Delta_e_end = 0.5; % can equal to 0.5
Delta_i_start = 0.035; % cannot equal to 0
...
filename = append('APC_',num2str(Delta_e_start),'_',num2str(Delta_e_end),'_',...
