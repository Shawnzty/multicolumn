function isPloted = plotTC(r,v,g,pop, Iattn, Delta_e,Delta_i, rawORenv, envWdo)
...
if maxVal<100 && sum(isnan(last))==0
    ...
    criteria = asCriteria(cond1Up_tmp, cond2Up_tmp, cond3Up_tmp, cond4Up_tmp, cond5Up_tmp); 
...
%     hold on
    ...
    location = append('figure/',state,criteria,filename);
    disp(location);
    saveas(gcf, location);
    end
