...
\begin{flushleft}
{\Large
\textbf\newline{?? Multicolumnar model finds gamma oscillation beyond winner-take-all strategy in visual attention} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
...
\newblock {Winner-take-all in a phase oscillator system with adaptation}
